...
3. **Choose the right file**
   ...
   On the releases page, find the latest release. Look for a Windows installer or an executable file, for example a `.exe` file. It might be named something like `dao-toki-Setup.exe`.  
